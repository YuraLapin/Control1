namespace ConsoleApp1
{
    ...
    //  + Экономия времени на отлов ошибок
    //
    //  - Занимают время на написание
    //  - Руководители могу довести до необходимости набирать покрытие бесполезными тестами
    //  - Требуют дополнительной квалификации разработчиков
    //  - Усложняют изменение кодовой базы
